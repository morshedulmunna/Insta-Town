...
const addToLiked = (id) => {
  likedPostsId.push(id); //like btn solve array push not plus
  showPosts(posts);
};
...
const displayLikedPosts = () => {
  document.getElementById("liked").innerHTML = ""; //Empty text Content
...
const displayReportedPosts = () => {
  document.getElementById("reported").innerHTML = ""; //empty Innter Html
